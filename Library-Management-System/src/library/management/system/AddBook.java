...
public class AddBook extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0), 2), "Add Books", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                if(t2.getText().length()==0 || t3.getText().length()==0 || t3.getText().length()==0 || t4.getText().length()==0 || t5.getText().length()==0 || t6.getText().length()==0){
                    JOptionPane.showMessageDialog(null, "Details needed!");
                }
                else
                {
